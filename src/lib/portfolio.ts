...
export const projects: Project[] = [
  {
    ...
    details: [
      { title: "Scale and cost", text: "During two days of development and testing, TypeSafe reported 77,928 API requests and 133.1 million processed tokens for $5.45 in model usage." },
